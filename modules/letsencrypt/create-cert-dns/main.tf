...
resource "acme_certificate" "certificate" {
  ...
  subject_alternative_names = length(var.subject_alternative_names) > 0 ? jsondecode(var.subject_alternative_names[element(var.domains, count.index)]) : []
